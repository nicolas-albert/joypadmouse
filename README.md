...
- **MangoHud toggle HUD (default)**: **LB + RB + Back/Select** (sends `Shift_R+F12`)
...
- `JOYPADMOUSE_MANGOHUD_PREKEY` (default `none`) — optional pre-key before the MangoHud hotkey (`shift`, `f12`, `esc`, `tab`, `space`, `enter`, `none`)
